...
void Mat4::Inverse() {
	...
	m[0][1] = -tempMat.m[0][1] * det;
	m[0][2] =  tempMat.m[0][2] * det;
	m[0][3] = -tempMat.m[0][3] * det;

	m[1][0] = -tempMat.m[1][0] * det;
	m[1][1] =  tempMat.m[1][1] * det;
	m[1][2] = -tempMat.m[1][2] * det;
	m[1][3] =  tempMat.m[1][3] * det;

	m[2][0] =  tempMat.m[2][0] * det;
	m[2][1] = -tempMat.m[2][1] * det;
	m[2][2] =  tempMat.m[2][2] * det;
	m[2][3] = -tempMat.m[2][3] * det;

	m[3][0] = -tempMat.m[3][0] * det;
	m[3][1] =  tempMat.m[3][1] * det;
	m[3][2] = -tempMat.m[3][2] * det;
