...
void Mat4::RotateX(float angleInDegrees) {
	...
	rotationMatrix.m[1][1] = Math::checkCos(theta); rotationMatrix.m[1][2] = -Math::checkSin(theta);
	rotationMatrix.m[2][2] = Math::checkCos(theta); rotationMatrix.m[2][1] = Math::checkSin(theta);
...
void Mat4::RotateY(float angleInDegrees) {
	...
	//calls a function to check if the result of the cos or sin function will be too small for a float to handle
	rotationMatrix.m[0][0] = Math::checkCos(theta); rotationMatrix.m[0][2] = -Math::checkSin(theta);
	rotationMatrix.m[2][0] = Math::checkCos(theta); rotationMatrix.m[2][2] = Math::checkSin(theta);
...
void Mat4::RotateZ(float angleInDegrees) {
	...
	//calls a function to check if the result of the cos or sin function will be too small for a float to handle
	rotationMatrix.m[0][0] = Math::checkCos(theta); rotationMatrix.m[0][1] = -Math::checkSin(theta);
	rotationMatrix.m[1][0] = Math::checkCos(theta); rotationMatrix.m[1][1] = Math::checkSin(theta);
