...
namespace GAME101_LAB7
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Calculate addition of first and second matrix 
            result = a + b;

            //If the result of the matrix addition is nut null, print matrix to Console
            if (result != null)
                result.print();
            else
                Console.WriteLine("Unable to add the matrices suplied.");
